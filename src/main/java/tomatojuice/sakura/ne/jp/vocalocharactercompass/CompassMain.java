...
public class CompassMain extends AppCompatActivity implements SensorEventListener{
	...
	private String mCameraId , numSensors;
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch(itemId){
			case R.id.theme:
				...
				break;
			case R.id.about:
				aboutIntent = new Intent(this,AboutMikuCompass.class);
