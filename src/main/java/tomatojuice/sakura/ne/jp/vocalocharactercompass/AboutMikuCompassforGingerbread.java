...
public class AboutMikuCompassforGingerbread extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
			...
			sensorText.setText(CompassMainforGingerbread.STR); // CompassMainで取得したセンサー一覧を出力
		}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
    	...
    	switch(itemId){
			case R.id.theme:
				...
				break;
			case R.id.about:
	    		intent = new Intent(this,AboutMikuCompassforGingerbread.class);
	    		startActivity(intent);
	    		intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
	    		finish();
				break;
